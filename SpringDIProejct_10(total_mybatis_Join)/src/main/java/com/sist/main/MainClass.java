...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		for(EmpVO vo:jList)
		{
			System.out.println(vo.getEmpno()+" "+vo.getEname()+" "+vo.getDvo().getDname()+" "+vo.getDvo().getLoc());
		}
