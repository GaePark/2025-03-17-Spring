...
public class BoardRestController {
  ...
  public ResponseEntity<BoardVO> update_detail(@PathVariable("no") int no)
  {
	  BoardVO vo=new BoardVO();
	  try
	  {
  ...
  public ResponseEntity<Map> update_detail(@RequestBody BoardVO vo)
  {
  ...
  @DeleteMapping("/board/delete_ok_vue/{no}/{pwd}")
