...
<div>
  ...
  <div class="text-cneter">
  	...
  	<c:if test="${startPage>1 }">
  		<li><a href="../seoul/find.do?page=${startPage-1 }&fd=${fd}">&lt;</a></li>
  	</c:if>
  	<c:forEach var="i" begin="${startPage }" end="${endPage}">
  	<li ${i==curpage?'class=active':'' } ><a href="../seoul/find.do?page=${i }&fd=${fd}">${i }</a></li>
  	</c:forEach>
  	<c:if test="${endPage<totalpage }">
  		<li><a href="../seoul/find.do?page=${endPage+1 }&fd=${fd}">&gt;</a></li>
  	</c:if>
  	</ul>
  </div>
</body>
